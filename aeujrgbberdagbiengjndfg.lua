...
_G.RadarSettings = {
    ...
    RADAR_RADIUS = 0; -- The size of the radar itself
    ...
    DISPLAY_TEAM_COLORS = false; -- Displays your teammates markers with either a custom color (change Team_Marker) or with that teams TeamColor (enable USE_TEAM_COLORS) 
